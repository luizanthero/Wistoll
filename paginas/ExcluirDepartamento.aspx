<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExcluirDepartamento.aspx.cs" Inherits="paginas_ExcluirDepartamento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentplaceholder1" Runat="Server">
    ...
    <script type="text/javascript">
        function error() {
            new PNotify({
                title: 'Me Desculpe',
                text: 'Não consegui excluir os dados. Acho que este departamento possui setores atrelados a ele, tente exclui-los primeiro.',
                type: 'error'
            });
        }
    </script>
