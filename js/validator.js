...
var validator = (function($){
	...
	*/
	message = {
		...
		min				: 'Não possui o minimo',
		max				: 'Ultrapassou o limite',
		number_min		: 'Muito curto',
		number_max		: 'Muito Longo',
		url				: 'invalid URL',
		number			: 'Isso não é um número',
		email			: 'endereço de email inválido',
		email_repeat	: 'Emails diferentes',
		password_repeat	: 'Passwords diferentes',
		repeat			: 'Não combinam',
		complete		: 'Corrija esta informção',
