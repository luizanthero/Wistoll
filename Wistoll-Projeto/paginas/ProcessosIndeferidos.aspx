<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ProcessosIndeferidos.aspx.cs" Inherits="paginas_Feed_ProcessosIndeferidos" %>
                        ...
                        <div class="col-md-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content estiloConsulta">
                                    ...
                                    <!-- start project list -->
                                    <asp:GridView ID="gridIndeferido" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered dt-responsive nowrap jambo_table tabela" OnRowCommand="gridIndeferido_RowCommand">
                                        <Columns>
